    ...
    <section ref={containerRef} className="relative h-screen min-h-[700px] overflow-hidden bg-navy-950">
      ...
      >
        ...
        <div className="overflow-hidden">
          {["PROTECT YOUR", "SPACE", "FROM EVERY PEST."].map((line, i) => (
            <motion.div
              key={line}
              initial={{ y: '110%' }}
              animate={{ y: 0 }}
        ...
        >
          ...
          <p className="text-white/30 text-xs sm:text-sm uppercase tracking-[0.2em]" style={{ fontFamily: 'var(--font-sans)' }}>
            {hero.trustBadge} &middot; 336 Herbert Chitepo Ave &middot; Est. 2015
          </p>
        </motion.div>
      ...
      <div className="hidden lg:flex absolute right-8 bottom-12 z-20">
        ...
        >
          Vibrant Pests control and Fumigation services Harare Zimbabwe &mdash; Harare, Zimbabwe
        </span>
      </div>
    </section>
  );
...
function MarqueeTicker() {
  const items = ["TERMITES", "RODENTS", "FUMIGATION", "PEST CONTROL", "COMMERCIAL", "RESIDENTIAL"];
...
function ServicesGrid() {
  ...
  const serviceImages = ['https://images.unsplash.com/photo-1584813539890-30373c796e72?w=800&q=80', 'https://images.unsplash.com/photo-1581578731548-c64695cc6952?w=800&q=80', 'https://images.unsplash.com/photo-1584813539890-30373c796e72?w=800&q=80', 'https://images.unsplash.com/photo-1581578731548-c64695cc6952?w=800&q=80', 'https://images.unsplash.com/photo-1584813539890-30373c796e72?w=800&q=80', 'https://images.unsplash.com/photo-1581578731548-c64695cc6952?w=800&q=80'];
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            ...
            <p className="text-white/50 text-sm sm:text-base leading-relaxed mb-6 max-w-lg" style={{ fontFamily: 'var(--font-sans)' }}>
              Founded with a singular mission: to deliver the highest quality cleaning services in Zimbabwe. What began as a small operation has grown into one of Harare's most trusted names.
            </p>
            <p className="text-white/35 text-sm leading-relaxed max-w-lg" style={{ fontFamily: 'var(--font-sans)' }}>
              Today, with a team of experienced professionals and 49+ satisfied clients, our track record speaks for itself. We bring the same meticulous attention to detail to every single project.
            </p>
            ...
            <div className="flex gap-10 sm:gap-16">
              ...
              <div>
                <div className="text-gold-500 font-heading text-3xl sm:text-4xl italic leading-none">49+</div>
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-8 -left-6 sm:-left-10 w-[45%] overflow-hidden border-4 border-navy-950 shadow-2xl">
                <img
                  ...
                  alt="Vibrant Pests control and Fumigation services Harare Zimbabwe detail work"
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          >
            <img
              src="https://images.unsplash.com/photo-1581578731548-c64695cc6952?w=800&q=80"
              alt="Vibrant Pests control and Fumigation services Harare Zimbabwe quality work"
              className="w-full aspect-[4/5] object-cover object-center"
              loading="lazy"
            />
          ...
          >
            ...
            <h2 className="font-heading text-white leading-[0.95] italic mb-12" style={{ fontSize: 'clamp(2rem, 4.5vw, 3rem)' }}>
              Why Choose <span className="text-gold-500">Vibrant</span>
            </h2>
    ...
    <section ref={ref} className="relative py-28 sm:py-36 lg:py-48 overflow-hidden">
      <motion.div className="absolute inset-0" style={{ y: bgY }}>
        <img
          ...
          alt="Vibrant Pests control and Fumigation services Harare Zimbabwe services"
        ...
        >
          ...
          <div className="mt-16 pt-8 border-t border-white/5 flex flex-col sm:flex-row items-center justify-center gap-6 text-xs text-white/25 uppercase tracking-[0.15em]" style={{ fontFamily: 'var(--font-sans)' }}>
            ...
            <span className="flex items-center gap-2">
              <MapPin size={14} /> 336 Herbert Chitepo Ave
            </span>
          </div>
        </motion.div>
      </div>
